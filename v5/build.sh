...
for part in core store access uistate kernel runner record engine counter report-data debug render text ui-flow ui-matrix ui-chart ui-outlook report clip view boot; do
